...
intro.goto(-250,70)
intro.write('You are the black ball, move the mouse to move your ball.',move=True, font=('Arial',16,'normal'))
intro.goto(-250,20)
intro.write('Eat balls that are smaller than you by bumping into them.',move=True,font=('Arial',16,'normal'))
intro.goto(-250,-30)
intro.write('If you bump into a bigger ball you will LOSE.',move=True,font=('Arial',16,'normal'))
# intro.goto(-240,-80)
